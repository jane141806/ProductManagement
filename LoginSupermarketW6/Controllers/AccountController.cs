...
namespace LoginSupermarketW6.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // GET: /Account/EmailSentNotification
        [AllowAnonymous]
        public ActionResult EmailSentNotification()
        {
            return View();
        }
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { Email = loginInfo.Email.ToLower() });
            }
        }
        ...
        //
        // GET: /Account/CheckEmailExternalLogin
        [AllowAnonymous]
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("IndexHome", "Products");
        }
